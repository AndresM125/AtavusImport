        ...
        <AuthenticatedView>
            <div className="min-w-screen min-h-screen p-8">
                <div className="flex flex-col justify-center items-center p-4 shadow-lg rounded bg-white">
                    ...
                    <button className="btn mt-2 w-[300px] btn-active" onClick={onSelectFileClicked}>Select File</button>
                    {selectedFile != null && <button className="btn mt-2 w-[300px] btn-success" onClick={onSubmitCSVFile}>Submit</button>}
                </div>
                ...
                <div className="mt-8 flex flex-col justify-center items-center p-4 shadow-lg rounded bg-white">
                    ...
                    <button onClick={onResetAllData} className="btn mt-4 btn-error">RESET ALL DATA</button>
                </div>
